...
String filebase = new String("C:\\Users\\jsh27\\OneDrive\\Documents\\GitHub\\AoC2017\\Day2_part1\\data\\mydata");
...
void setup() {
  ...
  {
    total+=calcDiff(input.lines.get(i));
    println("L:"+input.lines.get(i)+" T:"+total);
  }
}

public long calcDiff(String s)
{
